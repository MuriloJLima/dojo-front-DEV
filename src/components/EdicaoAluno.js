...
const EdicaoAluno = ({ id }) => {
  ...
  const getAluno = async () => {
    try {
      ...
      setAlunoId(response.data.data.dados_matricula.matri_dojo)
      ...
      <form onSubmit={handleSubmit}>
        ...
        <FormRow>
          <FormGroup>
            ...
            <Input type="text" name="dados_aluno.altura_aluno" value={aluno.dados_aluno.altura_aluno || ""} onChange={handleChange} 
            onInput={(e) => {
              e.target.value = e.target.value.replace(/[^0-9]/g, '');
            }}
            maxLength={3}
          ...
          <FormGroup>
            <Label>Peso (kg):</Label>
            <Input type="text" name="dados_aluno.peso_aluno" value={aluno.dados_aluno.peso_aluno || ""} onChange={handleChange} 
            onInput={(e) => {
              e.target.value = e.target.value.replace(/[^0-9]/g, '');
            }}
            maxLength={3} />
        ...
        <FormGroup>
          ...
          <Input type="text" name="dados_aluno.endereco_aluno" value={aluno.dados_aluno.endereco_aluno || ""} onChange={handleChange} required />
        </FormGroup>
        <SmallFormGroup>
